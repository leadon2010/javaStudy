...
public class MyFriendProc {
	...
	void insertUnivFriend() {
		...
		major = sc.nextLine();
		frn[cnt] = new UnivFriends(name, major, phone);
		System.out.println();
		frn[cnt].showInfo();
		cnt++;
	...
	void insertCompFriend() {
		...
		frn[cnt] = new UnivFriends(name, department, phone);
		cnt++;
	...
	void setData() {
		frn[cnt++] = new UnivFriends("LEE", "Computer", "1111-1111");
		frn[cnt++] = new UnivFriends("KIM", "Electric", "2222-2222");
		frn[cnt++] = new UnivFriends("YOON", "Electronic", "3333-3333");
		frn[cnt++] = new CompFriends("PARK", "Account", "4444-4444");
		frn[cnt++] = new UnivFriends("KIM", "Electric", "7777-7777");
		frn[cnt++] = new CompFriends("KWON", "Developer", "5555-5555");
		frn[cnt++] = new CompFriends("CHOI", "RND 1", "6666-6666");
