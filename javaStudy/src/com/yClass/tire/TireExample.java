package com.yClass.tire;

import com.yClass.tire.hankook.SnowTire;
import com.yClass.tire.kumho.BigWideTire;
...
public class TireExample {
	public static void main(String[] args) {
		...
		com.yClass.tire.hankook.SnowTire sTir = new com.yClass.tire.hankook.SnowTire();
		...
		com.yClass.tire.hankook.Tires tires = new com.yClass.tire.hankook.Tires();
		tires.start();
		tires.setVelocity(40);
		System.out.println(tires.currentVelocity() + "km/h 입니다.");

		com.yClass.tire.kumho.Tires tires2 = new com.yClass.tire.kumho.Tires();
		tires2.start();
		tires2.setSpeed(50);
